...
The one piece this design cannot fully scope in advance is Beaconkeeper: its image and seed (`runtime.directory` and `defaultSeed` from the manifest) need a real run to pin down.
